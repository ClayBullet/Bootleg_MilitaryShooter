...
public class InputScriptable : ScriptableObject
{
    ...
    [Header("DASH BUTTON")]
    [Space]
    public InputActions dashButton;
    ...
    [Header("HIT ALTERNATIVE BUTTON BUTTON")]
    [Space]
    public InputActions hitAltButton;

    [Header("THROWABLE BUTTON")]
    [Space]
    public InputActions throwableButton;
    public InputActions alternativeThrowableButton;
